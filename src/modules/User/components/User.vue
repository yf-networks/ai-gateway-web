...
<template>
    <div>
        ...
        <Drawer
            ...
            :mask-closable="false"
        >
            <CreateUser v-if="isHiden && handleType === 'create'" @submit="submitData" />
            <UpdatePassword
...
export default {
    ...
    methods: {
        ...
        upsertPassWord(data, self) {
            ...
            this.$request({
                url: this.$urlFormat('auth/users/{user_name}/passwd', {
        ...
        onDel(params) {
            this.$Modal.confirm({
                ...
                content:
                    this.$t('com.confirmDelX', { obj: this.$t('user.name') }) +
