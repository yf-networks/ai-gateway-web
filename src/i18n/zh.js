...
export default {
  ...
  apiKey: {
    ...
    descriptionLengthError: '描述不能超过1024个字符',
  ...
  entity: {
    ...
    tpmMaxTokensInvalid: '第{index}条TPM规则最大Token数必须大于0',
    ...
    rpmMaxRequestsInvalid: '第{index}条RPM规则最大请求数必须大于0',
    ...
    ruleNameDuplicate: '规则名称 {name} 重复',
    rateLimitRuleRequired: '启用限流时，至少配置一项限流规则（TPM/RPM/最大并发）',
