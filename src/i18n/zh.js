...
export default {
  ...
  route: {
    ...
    atLeastOneCondition: '至少需要配置一项匹配条件：流量标签、域名、路径匹配、方法、Header匹配、模型匹配',
    tipSubmitting: '提交中',
  ...
  cluster: {
    ...
    tipMountEppAfterUnmountOthers: '挂载EPP类型实例池前，请先卸载其他已挂载实例池'
  },
  subCluster: {
    name: '子集群',
  ...
  apiForm: {
    ...
    enableStatus: '启用状态',
    notEnable: '不启用',
    keyPlaceholder: '格式为产品线名称+多个随机生成的码段，如：testproduct-3a51-4289-4c05-c5c5c5',
    quota: '限额',
